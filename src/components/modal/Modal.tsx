...
const OnboardingModal = ({
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex flex-col items-center justify-center z-50">
      <div className="flex flex-col items-center justify-center gap-[40px] bg-white rounded-[20px] shadow-lg p-[20px] w-[calc(100%-48px)] ">
        <p className="text-[25px]">{contents}</p>
        <button
          type="button"
          className="w-full bg-primary text-white py-[16px] items-center justify-center rounded-[20px]"
          onClick={onClose}
        >
          확인
        </button>
