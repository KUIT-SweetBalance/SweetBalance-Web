...
import {
  fetchRecoringDrinks,
  DeleteRecordingDrinks,
} from '../../../api/mypage/record/MypageRecord';
...
const MypageRecord: React.FC = () => {
  ...
  >({
    ...
    ) => fetchRecoringDrinks(pageParam, isReversed),
  ...
  const filteredDrinks =
    drinkList?.pages
      ...
      .filter((drink) =>
        searchTerm
          ? drink.beverageName.toLowerCase().includes(searchTerm.toLowerCase())
          : true,
      ) || [];
